...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentesListaEstudiosListaEstudiosComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    StudyListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 23,
      vars: 5,
      consts: [[1, "w-50", "marginTop1", "marginBottom5"], [1, "displayFlex", "marginBottom5"], [1, "cardStyle", "greenColor"], [1, "displayGrid"], [1, "cardStyle", "redColor"], [1, "cardStyle", "blueColor"], [4, "ngIf"], [1, "filter-section", "marginBottom5"], ["appearance", "fill"], [3, "ngModel", "ngModelChange"], [3, "value", 4, "ngFor", "ngForOf"], ["appearance", "fill", 4, "ngIf"], ["mat-button", "", 1, "buttonPrimary", 3, "disabled", "click"], ["mat-button", "", 1, "buttonPrimary", 3, "click"], [1, "mat-elevation-z8"], ["mat-table", "", "matSort", "", 3, "dataSource"], ["matColumnDef", "Nombre"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "Pais"], ["matColumnDef", "Resultado"], ["matColumnDef", "Detalle"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], [3, "value"], ["multiple", "", 3, "formControl"], ["class", "example-additional-selection", 4, "ngIf"], [1, "example-additional-selection"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], [3, "innerHtml", "ngStyle"], ["mat-header-cell", ""], ["mat-icon-button", "", "color", "primary", "matTooltip", "Detalle estudio", "matTooltipPosition", "right", "aria-label", "Detalle", 3, "click"], ["mat-header-row", ""], ["mat-row", ""]],
  ...
  function srcAppServiciosEstudioServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    StudyService.ɵfac = function StudyService_Factory(t) {
      return new (t || StudyService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_http_client_service__WEBPACK_IMPORTED_MODULE_3__["CustomHttpClient"]));
    };
